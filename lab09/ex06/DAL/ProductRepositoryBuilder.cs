...
namespace ex06.DAL
{
    public class ProductRepositoryBuilder : IRepositoryBuilder<ProductRepository, Product>
    {
        ...
        {
            // Load settings for product repository 
        ...
        public ProductRepository Build()
        {
            ...
            int initSettingsDuration = Random.Shared.Next(1, 5) * 1000;
            Thread.Sleep(initSettingsDuration);
            lock (_object)
            {
                _rc = !_rc;
                localRc = _rc;
